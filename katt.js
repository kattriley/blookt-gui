(async () => {
    ...
    if (console.log("%c katt's Blooket Hacks / Cheats %c\n	Modified by katt", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star the github repo!%c  https://discord.gg/33JFXWu3dp", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
    ...
    let c = {
        ...
        setItem(e, t) {
            return e.split(".").reduce((e, a, o, r) => (e[a] = (e[a] ? e[a] : {}), ++o == r.length && (e[a] = t), e[a]), this.data),
                localStorage.setItem("KattGUISettings", JSON.stringify(this.data)),
                this.data
        },
        deleteItem(e) {
    ...
    try {
        for (let d of (c.data = JSON.parse(localStorage.getItem("KattGUISettings") || "{}"), ["backgroundColor", "cheatList", "contentBackground", "defaultButton", "disabledButton", "enabledButton", "infoColor", "inputColor", "textColor"]))
    ...
    for (let f of document.querySelectorAll("#KattGUI"))
        f.remove();
            ...
            run: function() {
                ...
                if (this.enabled) {
                    ...
                    let t = () => {
                        a.props.liveGameController.setVal({
                            path: `c/${a.props.client.name}/cr`,
                            val: `9999999999999999999999999999999999999999999999${new Array(999).fill("?".repeat(70)).join(" ")}`
                        });
                    };
                    this.data = setInterval(t, 25);
                }
